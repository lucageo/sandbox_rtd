...
//     map.setFilter("countries_rtd", ["has", "id_gaul"]);
//   }
}
...
var miolayer = map.getLayer('point');
    ...
    map.fire('click', { lngLat: ll, point:pointsel })
      ...
      map.addLayer({
        ...
        "source": {
            "type": "vector",
            "tiles": ["https://geospatial.jrc.ec.europa.eu/geoserver/gwc/service/wmts?layer=dopa_analyst:countries_rtd&tilematrixset=EPSG:900913&Service=WMTS&Request=GetTile&Version=1.0.0&Format=application/x-protobuf;type=mapbox-vector&TileMatrix=EPSG:900913:{z}&TileCol={x}&TileRow={y}"]
            },
        "source-layer": "countries_rtd",
 ...
 map.addLayer({
  ...
  ["==", "protected", 0]
    ...
    var features = map.queryRenderedFeatures({ layers: ["countries_rtd"] });
  ...
  map.on("mousemove", "countries_rtd", function (e) {
    ...
    popup.setLngLat(e.lngLat).setHTML(
          " <ul><li><div id = 'country_scores_main_b'>Average Score for <b>"+country_name+"</b></div>"+
                "<div><span class = 'coll_item_title' > Variable 1 ("+carbon.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+carbon_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 2 ("+water.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+water_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 3 ("+natural.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+natural_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 4 ("+forest.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+forest_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 5 ("+mammals.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+mammals_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 6 ("+mammals_th.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+mammals_th_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 7 ("+amphibians.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+amphibians_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 8 ("+amphi_th.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+amphi_th_w+"%'></div></div>"+
                  "<span class = 'coll_item_title' > Variable 9  ("+birds.toLocaleString()+")</span>"+
                  "<div id='progressbar'><div style='width:"+birds_w+"%'></div></div>"+         
                  "<span class = 'coll_item_title' > Variable 10 ("+birds_th.toLocaleString()+")</span>"+
  ...
  map.on("mouseleave", "countries_rtd", function () {
...
popup.setLngLat(coordinates).setHTML(
  ...
  " <ul><li><div id = 'country_scores_main_b'>Scores</div>"+
        "<div><span class = 'coll_item_title' > Variable 1 ("+carbon.toLocaleString()+")</span>"+
          "<div id='progressbar'><div style='width:"+carbon_w+"%'></div></div>"+
          "<span class = 'coll_item_title' > Variable 2 ("+water.toLocaleString()+")</span>"+
          "<div id='progressbar'><div style='width:"+water_w+"%'></div></div>"+
...
layer_country.addEventListener('change', function() {
  ...
  map.setPaintProperty('countries_rtd', 'fill-color', ['interpolate',['linear'],['get', layer_country_value],0, '#ffffd4',10, '#ffefb5',50, '#ffde96',100, '#fec46c',150, '#fea73f',250, '#f68c23',350, '#e67217',500, '#d25a0c',750, '#b64708',1000, '#993404']);
});
...
setTimeout(function(){
  ...
  map.on('click', 'countries_rtd', function(e) {
...
// compute variable values for pa in country 
      ...
      $('#country_name').empty().append("<div id='country_name_'><p>Average Scores for "+feature.properties.adm0_name+"</p></div> "+
      ...
      "<div id = 'country_pop_main' class = 'card_custom country_pop_main_b'><div id='country_pop_title' class = 'section_out_title'> <p>Outside Project Areas</p> </div><div id='country_popx2' class = 'section_out_number'> <p> "+all_country_avg_val.toFixed(2)+"</p> </div></div>"+
      "<div id = 'country_pop_main' class = 'card_custom country_pop_main_c'><div id='country_pop_title' class = 'section_out_title'> <p>Inside Project Areas</p> </div><div id='country_popx' class = 'section_out_number'> <p> "+pa_country_avg_val.toFixed(2)+"</p> </div></div>"+

      " <ul class= 'collapsible country_scores_main '><li class='active'><div id = 'country_scores_main_b' class='collapsible-header country_scores_main_b'><i class='material-icons '>grain</i>Resources</div>"+
        "<div class='collapsible-body'>"+
        "<div id='varlegend'><span class='square_var' style='background-color: #8ea67d'></span>Average value <b>outside</b> Project Areas</div>"+
        "<div id='varlegend'><span class='square_var' style='background-color: #576e38'></span>Average value <b>inside</b> Project Areas</div>"+
        "<hr>"+
          "<span class = 'coll_item_title' >Variable 1 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 2 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 3 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 4 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 5 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 6 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 7 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 8 </span>"+
          ...
          "<span class = 'coll_item_title' > Variable 9 </span>"+
          ...
          "<span class = 'coll_item_title' >Variable 10 </span>"+
    ...
    function toggle(button)
{
  if(document.getElementById("1").value=="OFF"){
   ...
   document.getElementById("1").value="OFF";}
      ...
      var cfeatures = map.queryRenderedFeatures(e.point, { layers: ['countries_rtd'] });
      var filter = cfeatures.reduce(function(memo, feature) {
         ...
         map.setFilter("countries_rtd", filter);
  ...
  $('input.checkbox_check').change(function(){
      ...
      setTimeout(function(){
      $("#submit").click();
      $('.country_sel_legend_title').html('Score in Country <br><b>Outside Project Areas');
    },1000);
...
$("#submit").click(function () { 
  ...
  console.log(tilesLoaded);
    ...
    var avg_val = (mean_carbon*score_carbon)+(mean_water*score_water)+(mean_natural*score_natural)+(mean_forest*score_forest)+(mean_mammals*score_mammals)+(mean_amphibians*score_amphibians)+(mean_th_mammals*score_th_mammals)+(mean_th_amphibians*score_th_ambhibians)+(mean_birds*score_birds)+(mean_th_birds*score_th_birds)
        ...
        if ($('input.checkbox_check').is(':checked')) {
          setTimeout(function(){
            $('.country_sel_legend_title').html('Score in Country <br><b>excluding Project Areas');

            $('.legend').append("<br><div id='country_prot_legend'> <p class='country_sel_legend_title'>Project Areas</p>"+
            "<div><span class='square_pa'style='background-color: #595958'></span>Project Areas Boundaries</div>"+
